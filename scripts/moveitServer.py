...
class MoveIt_Control:
    ...
    def move_p(self, tool_configuration=None,a=1,v=1):
        ...
        q = quaternion_from_euler(tool_configuration[5],tool_configuration[4],tool_configuration[3])
    ...
    def grasp(self, position, rpy=None,open_size=0.65, k_acc=0.8, k_vel=0.8, speed=255, force=125):
        ...
        # 准备工作
        grasp_home = [15.96 / 180 * np.pi,-78.97/ 180 * np.pi,-82.33/ 180 * np.pi,-108.58/ 180 * np.pi,89.90/ 180 * np.pi,-74.08/ 180 * np.pi]  # you can change me
